...
namespace AutomacaoFuncional.tests.pages
{
    class SelecionarDocumentosMap
    {
        ...
        [FindsBy(How = How.XPath, Using = "//ng-form[@name='documentosForm']//div[2]//div//div[1]//div[1]//div[3]//div//span[1]//a[1]")]
        [CacheLookup]
        public IWebElement BtnCpfFrente { get; set; }

        [FindsBy(How = How.XPath, Using = "//ng-form[@name='documentosForm']/./div[2]//div/./div[1]/./div[1]//div[4]//div//span[1]//a")]
        [CacheLookup]
        ...
        [FindsBy(How = How.XPath, Using = "//div[@class='row botoes']//a//span[@class='hidden-xs m-r-20'][1]")]
        [CacheLookup]
